...
# Map CP_ARM_SUBSCRIPTION_ID -> ARM_SUBSCRIPTION_ID
# This maps the control plane subscription id variable to the standardized ARM_SUBSCRIPTION_ID name.
Copy-AzDevOpsVariableGroupVariable -ProjectName $ADO_Project -VariableGroupNameSource $VariableGroupName -VariableGroupNameTarget $VariableGroupName -VariableName "CP_ARM_SUBSCRIPTION_ID" -TargetVariableName "ARM_SUBSCRIPTION_ID"  -Verbose
