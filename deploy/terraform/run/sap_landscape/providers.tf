...
provider "azurerm"                     {
                                         ...
                                         subscription_id            = length(var.subscription_id) > 0 ? var.subscription_id : coalesce(data.azurerm_key_vault_secret.subscription_id_v2[0].value, data.azurerm_key_vault_secret.subscription_id[0].value)
                                         ...
                                         client_secret              = var.use_spn ? coalesce(ephemeral.azurerm_key_vault_secret.client_secret[0].value, ephemeral.azurerm_key_vault_secret.client_secret_v2[0].value): null
...
provider "azurerm"                     {
                                         ...
                                         client_id                  = var.use_spn ? coalesce(data.azurerm_key_vault_secret.cp_client_id_v2[0].value, data.azurerm_key_vault_secret.cp_client_id[0].value) : null
                                         client_secret              = var.use_spn ? coalesce(ephemeral.azurerm_key_vault_secret.cp_client_secret_v2[0].value, ephemeral.azurerm_key_vault_secret.cp_client_secret[0].value) : null
                                         tenant_id                  = var.use_spn ? coalesce(data.azurerm_key_vault_secret.cp_tenant_id_v2[0].value, data.azurerm_key_vault_secret.cp_tenant_id[0].value) : null
                                         use_msi                    = var.use_spn ? false : true
                                         storage_use_azuread        = true
                                       }
