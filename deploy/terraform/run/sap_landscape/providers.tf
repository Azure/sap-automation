...
provider "azurerm"                     {
                                         ...
                                         client_id                  = var.use_spn ? coalesce( data.azurerm_key_vault_secret.client_id[0].value): null
                                         client_secret              = var.use_spn ? coalesce(ephemeral.azurerm_key_vault_secret.client_secret[0].value): null
                                         tenant_id                  = var.use_spn ? coalesce(data.azurerm_key_vault_secret.tenant_id[0].value): null
...
provider "azurerm"                     {
                                         ...
                                         client_id                  = var.use_spn ? coalesce(data.azurerm_key_vault_secret.cp_client_id[0].value) : null
                                         client_secret              = var.use_spn ? coalesce(ephemeral.azurerm_key_vault_secret.cp_client_secret[0].value) : null
                                         tenant_id                  = var.use_spn ? coalesce(data.azurerm_key_vault_secret.cp_tenant_id[0].value) : null
                                         use_msi                    = var.use_spn ? false : true
                                         storage_use_azuread        = true
                                       }
