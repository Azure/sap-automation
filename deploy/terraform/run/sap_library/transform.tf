...
locals {
  ...
  dns_settings                         = {
                                           ...
                                           management_dns_subscription_id = trimspace(coalesce(var.management_dns_subscription_id, try(local.spn.subscription_id, " ")))

                                           privatelink_dns_subscription_id = trimspace(coalesce(var.privatelink_dns_subscription_id,var.management_dns_subscription_id, try(local.spn.subscription_id, " "), " "))
                                           privatelink_dns_resourcegroup_name = trimspace(coalesce(var.privatelink_dns_resourcegroup_name, var.management_dns_resourcegroup_name, " "))
