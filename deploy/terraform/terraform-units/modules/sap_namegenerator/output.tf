output "naming" {
  ...
  value                                = {
                         ...
                         virtualmachine_names = {
                           ...
                           HANA_COMPUTERNAME        = var.database_high_availability ? flatten(local.hana_computer_names_ha) : local.hana_computer_names
                           HANA_SECONDARY_DNSNAME   = var.database_high_availability ? flatten(local.hana_secondary_dnsnames_ha) : local.hana_secondary_dnsnames
                           HANA_VMNAME              = var.database_high_availability ? flatten(local.hana_server_vm_names_ha) : local.hana_server_vm_names
