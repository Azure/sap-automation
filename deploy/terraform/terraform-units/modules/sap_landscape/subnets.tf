...
data "azurerm_subnet" "storage" {
  ...
  name                                 = split("/", var.infrastructure.virtual_networks.sap.subnet_storage.prefix.id)[10]
  resource_group_name                  = split("/", var.infrastructure.virtual_networks.sap.subnet_storage.prefix.id)[4]
  virtual_network_name                 = split("/", var.infrastructure.virtual_networks.sap.subnet_storage.prefix.id)[8]
}
