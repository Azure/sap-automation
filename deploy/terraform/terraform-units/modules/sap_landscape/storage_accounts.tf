...
resource "azurerm_private_endpoint" "storage_bootdiag" {
  ...
  name                = format("%s%s%s", local.resource_prefixes.storage_private_link_diag, local.prefix, local.resource_suffixes.storage_private_link_diag)
  ...
  private_service_connection {
    name                           = format("%s%s%s", local.resource_prefixes.storage_private_svc_diag, local.prefix, local.resource_suffixes.storage_private_svc_diag)
...
resource "azurerm_private_endpoint" "witness_storage" {
  ...
  name                = format("%s%s%s", local.resource_prefixes.storage_private_link_witness, local.prefix, local.resource_suffixes.storage_private_link_witness)
  resource_group_name = local.rg_name
  location            = local.rg_exists ? data.azurerm_resource_group.resource_group[0].location : azurerm_resource_group.resource_group[0].location
  ...
  private_service_connection {
    name                           = format("%s%s%s", local.resource_prefixes.storage_private_svc_witness, local.prefix, local.resource_suffixes.storage_private_svc_witness)
    is_manual_connection           = false
...
resource "azurerm_private_endpoint" "transport" {
  ...
  name                = format("%s%s%s", local.resource_prefixes.storage_private_link_transport, local.prefix, local.resource_suffixes.storage_private_link_transport)
  resource_group_name = local.rg_name
  location            = local.rg_exists ? data.azurerm_resource_group.resource_group[0].location : azurerm_resource_group.resource_group[0].location
  ...
  private_service_connection {
    name                           = format("%s%s%s", local.resource_prefixes.storage_private_svc_transport, local.prefix, local.resource_suffixes.storage_private_svc_transport)
    is_manual_connection           = false
