...
output "ams_resource_id"                        {
                                                  ...
                                                  value       = local.create_ams_instance ? (
                                                    length(try(azapi_resource.ams_instance[0].id, "")) == 0 ? try(
                                                      azapi_resource.ams_instance_with_laws[0].id, "") : try(
                                                        azapi_resource.ams_instance[0].id, "")) : ""
                                                }
