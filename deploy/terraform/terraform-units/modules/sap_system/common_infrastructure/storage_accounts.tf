...
resource "azurerm_private_endpoint" "shared" {
  ...
  name                = format("%s%s%s", local.resource_prefixes.storage_private_link_install, local.prefix, local.resource_suffixes.storage_private_link_install)
  ...
  private_service_connection {
    name                           = format("%s%s%s", local.resource_prefixes.storage_private_svc_install, local.prefix, local.resource_suffixes.storage_private_svc_install)
