...
resource "azurerm_linux_virtual_machine" "app" {
  ...
  source_image_id = var.application.app_os.type == "custom" ? local.app_os.source_image_id : null

  dynamic "source_image_reference" {
    for_each = range(var.application.app_os.type == "source_image" ? 1 : 0)
    content {
  ...
  dynamic "plan" {
    for_each = range(var.application.app_os.type == "marketplace" ? 1 : 0)
    content {
