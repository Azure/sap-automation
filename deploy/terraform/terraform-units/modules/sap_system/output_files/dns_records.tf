resource "azurerm_private_dns_a_record" "app_secondary" {
  ...
  ttl                 = 3600
  records             = [try(var.application_server_secondary_ips[count.index], null)]
...
resource "azurerm_private_dns_a_record" "scs_secondary" {
  ...
  resource_group_name = var.management_dns_resourcegroup_name
  ttl                 = 3600
  records             = [try(var.scs_server_secondary_ips[count.index], null)]
...
resource "azurerm_private_dns_a_record" "web_secondary" {
  ...
  resource_group_name = var.management_dns_resourcegroup_name
  ttl                 = 3600
  records             = [try(var.webdispatcher_server_secondary_ips[count.index], null)]
...
resource "azurerm_private_dns_a_record" "db_secondary" {
  ...
  resource_group_name = var.management_dns_resourcegroup_name
  ttl                 = 3600
  records             = [try(var.db_server_secondary_ips[count.index], null)]
