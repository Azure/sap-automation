...
| --- | --- | --- |
| [`Azure/sap-automation`](https://github.com/Azure/sap-automation) | Central documentation, framework source, local execution, and shared pipeline templates | Terraform, Ansible, scripts, pipeline templates, and Web application |
...
| [`Azure/sap-automation-bootstrap`](https://github.com/Azure/sap-automation-bootstrap) | Azure DevOps setup and Azure Pipelines execution | Customer-repository structure, wrapper pipelines, variable groups, service connections, and agent-pool setup |
...
| Azure DevOps wrapper pipeline, repository resource, variable group, service connection, or agent setup | `Azure/sap-automation-bootstrap` |
