...
| Deployment validation | GitHub Actions | Pending | The `13-quality-assurance.yml` workflow is proposed in [`Azure/sap-automation-gh-bootstrap#28`](https://github.com/Azure/sap-automation-gh-bootstrap/pull/28) and is not available until that pull request merges. The preparation script in this repository already supports the GitHub Actions platform. |
