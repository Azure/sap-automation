...
| Azure DevOps | Your organization uses Azure Repos, Azure Pipelines, service connections, variable groups, and agent pools. | [Set up SDAF with Azure DevOps](https://github.com/Azure/sap-automation-bootstrap) |
